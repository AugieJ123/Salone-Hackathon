...
def show_flight(flight_info):
    ...
    # maxLat = max([flight_info[0][0],flight_info[1][0]])
    # minLat = min([flight_info[0][0], flight_info[1][0]])
    #
    # maxLon = max([flight_info[0][1], flight_info[1][1]])
    # minLon = min([flight_info[0][1], flight_info[1][1]])
...
def getLocation(airport):
    # if dictionary_[airport] not in key:
    #     print('Location not found..')
    return dictionary_[airport]

# def checklocation(airport):
#     if dictionary_[airport] not in key:
#         return print('Location not find')
#
# print(checklocation(airports))

...
# this shows the date and time of the flights
...
def process_flights(start_time: int, end_time: int) -> List[Dict[str, str]]:
    ...
    for departure in api_response:
        ...
        _information.append({"departure airport": departure_airport, "arrival airport": destination_airport})



    # Return the data
    return json.dumps(_information)
...
@app.route('/flights/<start_time>')
def flights(start_time):
    """API for flight information
...
@app.route('/coordinates/<start_time>')
def coordinates(start_time) -> str:
    """API for coordinate information
